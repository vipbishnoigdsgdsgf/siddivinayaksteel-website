...
import { Star, Phone, Calendar, Loader, Bookmark, Heart, ImagePlus } from "lucide-react";
  ...
  useEffect(() => {
    const fetchProjects = async () => {
      try {
        ...
        // Build the query with type assertion
  ...
  const toggleLike = async (id: string) => {
    ...
    try {
      if (likedProjects.includes(id)) {
        // Remove like with type assertion
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              <h1 className="text-4xl font-bold text-white mb-6">
                Our <span className="text-steel">Portfolio</span>
              </h1>
              <p className="text-lg text-gray-400 max-w-3xl mx-auto">
                Explore our extensive collection of steel fitting projects showcasing our craftsmanship and design expertise.
              </p>
              
              {/* New Gallery Link */}
              <div className="mt-6 flex justify-center">
                <Link to="/gallery">
                  <Button className="bg-steel hover:bg-steel-700 text-white flex items-center gap-2">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="mt-4 max-w-2xl mx-auto text-lg text-gray-400">
                Browse through our extensive collection of steel and glass fitting projects completed across India by Ramesh Bishnoi.
              </p>
            </div>
                        ...
                        <CardContent className="p-6">
                          ...
                          <div className="mt-4 pt-4 border-t border-gray-800 flex justify-between">
                            <Button 
                              size="sm" 
                              variant="outline" 
                              className="flex items-center gap-1 border-steel/40 hover:border-steel"
                              onClick={() => window.location.href = `/contact?project=${project.id}`}
                            >
                            ...
                            <Button 
                              ...
                              variant="outline" 
                              className="flex items-center gap-1 border-steel/40 hover:border-steel"
                              onClick={() => window.open('https://jsdl.in/DT-283E5AIMN4P', '_blank')}
